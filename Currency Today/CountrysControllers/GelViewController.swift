...
class GelViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    func fetchJson() {
        guard let url = URL(string: "https://open.er-api.com/v6/latest/GEL") else{ return }
