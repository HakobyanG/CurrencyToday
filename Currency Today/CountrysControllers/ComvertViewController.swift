//
//  ComvertViewController.swift
//  Currency Today
//
//  Created by Garnik on 2/8/22.
//
...
class ComvertViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        currencyText.placeholder = "yourmoney".localized()
    ...
    func addView() {
        ...
        gradientLayer.colors = [
            ...
            UIColor.systemTeal.cgColor,
            UIColor.init(red: 96/255, green: 211/255, blue: 191/255, alpha: 1).cgColor,
            UIColor.init(red: 96/255, green: 211/255, blue: 191/255, alpha: 1).cgColor,
            UIColor.init(red: 87/255, green: 224/255, blue: 198/255, alpha: 1).cgColor,
            UIColor.init(red: 87/255, green: 224/255, blue: 198/255, alpha: 1).cgColor,
        ]
        view.layer.addSublayer(gradientLayer)
        view.addSubview(firstCount)
        view.addSubview(firstLabel)
        view.addSubview(currencyText)
        view.addSubview(stack)
        view.addSubview(pickerV)
